package com.farshad.moviesAppCompose.ui.login
...
import com.farshad.moviesAppCompose.databinding.FragmentLoginBinding
import com.farshad.moviesAppCompose.ui.MainActivity
import com.farshad.moviesAppCompose.ui.login.epoxy.LoginEpoxyController
import com.farshad.moviesAppCompose.ui.login.model.LoginResponseModel
import com.farshad.moviesAppCompose.ui.login.model.TextFieldStatusModel
...
//                controller.setData(response)
        ...
        viewModel.validationFlow.asLiveData().observe(viewLifecycleOwner){ validationLiveData->
            LoadingDialog.hideLoading()
